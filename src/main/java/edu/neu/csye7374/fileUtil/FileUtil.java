...
public class FileUtil {
    ...
    public static void writeToFile(String filename, CarBuilder carBuilder) {
        try {
            FileWriter fw = new FileWriter(filename, true);
            BufferedWriter bw = new BufferedWriter(fw);
            PrintWriter out = new PrintWriter(bw);
            out.println(carBuilder.getCarId());
            out.println(carBuilder.getCarName());
            out.println(carBuilder.getCarPrice());
            out.println(carBuilder.getCarCategory());
            out.println(carBuilder.getCarManufacturer());
        } catch (IOException e) {
            e.printStackTrace();
        }
    }

    public static void appendEntryToFile(String fileName, CarBuilder carBuilder) {
        FileWriter fr = null;
        BufferedWriter bw = null;
        try {
            fr = new FileWriter(fileName, true);
            bw = new BufferedWriter(fr);
            bw.append(carBuilder.getCarId() + ",");
            bw.append(carBuilder.getCarName() + ",");
            bw.append(carBuilder.getCarPrice() + ",");
            bw.append(carBuilder.getCarCategory() + ",");
            bw.append(carBuilder.getCarManufacturer() + "\n");
        } catch (IOException ex) {
